...
//we can see all the elections by HTTP Get method 
...
//we can see all the elections by a specific id by the HTTP Get method
app.get('/api/Votes/Elections/:id', function(req, res) {
	...
	//manage the errors according to the contrat:
	/*404 ---> Not found
	200 ---> Request Succeed*/
	if(election === ""){
		res.status(404);
...
//creation of elections specified by the invoqued id
