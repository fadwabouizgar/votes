...
namespace TD_YMCA
{
  ...
  {
    /// <summary>
      ///we begin with initializing our variables
    /// </summary>
    ...
    public MainWindow()
    {
      ...
      //reporting of all users that can vote
    ...
    private void DrawBody(IReadOnlyDictionary<JointType, Joint> joints, IDictionary<JointType, Point> jointPoints, DrawingContext drawingContext, Pen drawingPen)
    {
      ...
      //We use StringBuilder to use JSON
      ...
      if (listeVotant.Count != 0)
      {
        ...
        //in case we have left hand lifted
        ...
        if (hasVoted)
        {
              ...
              if (choix == "Droite")
              {
                  dataJson = SB.Append("'choix':1,\"" + "'prenom'émoticône unsure'" + listeVotant[0] + "'" + "}");
              }
              else
              {
                  dataJson = SB.Append("'choix':2,\"" + "'prenom'émoticône unsure'" + listeVotant[0] + "'" + "}");
              }
          /// <summary>
